...
train_data_url = 'input/system_train_df_v7.csv'
dev_data_url = 'input/system_dev_df_v7.csv'
test_data_url = 'input/system_test_df_v7.csv'
result_data_url = 'output/exp28_results.csv'
...
model = BertForSequenceClassification.from_pretrained('model/FineTuned')
tokenizer = BertTokenizerFast.from_pretrained('model/FineTuned')
